...
$email_pass = "senha do e-mail contato@origamid.com"; // Senha do e-mail

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraft.com"; // URL do Site

$host_smtp = "smtp.nome do site.com ou sub4.mail.dreamhost.com"; // HOST SMTP Ex: smtp.domain.com.br
// cada e-mail pode ser suas diferenças, então pesquise sobre sua hospedagem para ver.
$host_port = "587 ou 465"; // Porta do Host, geralmente 465 ou 587
